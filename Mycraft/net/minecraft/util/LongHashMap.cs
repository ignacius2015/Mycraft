...
namespace Mycraft.net.minecraft.util
{
    public class LongHashMap
    {
         ...
         */
        private const float percentUseable = 0.75F;

        /** count of times elements have been added/removed */
        [NonSerialized]
        private  volatile int modCount;
        private static readonly String __OBFID = "CL_00001492";
        ...
        public bool containsItem(long p_76161_1_)
        {
            return this.getEntry(p_76161_1_) != null;
        }
        public Entry getEntry(long p_76160_1_)
        {
     ...
     */
        private void resizeTable(int p_76153_1_)
        {
            ...
            else
            {
                ...
                this.hashArray = var4;
                this.capacity = (int)((float)p_76153_1_ * percentUseable);
            }
        }
        /**
     ...
     */
        public Entry removeKey(long p_76152_1_)
        {
     ...
     */
        ...
        public sealed class Entry
        {
            ...
            internal int hash;
            private static readonly String __OBFID = "CL_00001493";
            private int p_76156_1_;
            private long p_76156_2_;
            private object p_76156_4_;
            private Entry var6;

            public Entry(int p_i1553_1_, long p_i1553_2_, Object p_i1553_4_, LongHashMap.Entry p_i1553_5_)
            {
            ...
            public Entry(long p_76156_1_, long p_76156_2_, object p_76156_4_, Entry var6)
            {
                this.p_76156_1_ = (int)p_76156_1_;
                this.p_76156_2_ = p_76156_2_;
                this.p_76156_4_ = p_76156_4_;
                this.var6 = var6;
            }
