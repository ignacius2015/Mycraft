...
namespace net.minecraft.util
{
    ...
    public interface IChatComponent : java.lang.Iterable
    {
    ...
    public class IChatComponent_Serializer : JsonDeserializer, JsonSerializer
    {
        internal static readonly Gson field_150700_a;
        internal const string __OBFID = "CL_00001263";

        public virtual IChatComponent deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_)
        {
            ...
            else if (!p_deserialize_1_.isJsonObject())
            {
                if (p_deserialize_1_.isJsonArray())
                {
                    ...
                    while (var14.hasNext())
                    {
                        ...
                        IChatComponent var17 = this.deserialize(var16, var16.GetType(), p_deserialize_3_);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (var4.has("with"))
                    {
                        ...
                        for (int var9 = 0; var9 < var8.Length; ++var9)
                        {
                            ...
                            if (var8[var9] is ChatComponentText)
                            {
                ...
                ((IChatComponent)var5).ChatStyle = (ChatStyle)p_deserialize_3_.deserialize(p_deserialize_1_, typeof(ChatStyle));
                return (IChatComponent)var5;
            }
        }

        internal virtual void func_150695_a(ChatStyle p_150695_1_, JsonObject p_150695_2_, JsonSerializationContext p_150695_3_)
        {
        ...
        public virtual JsonElement serialize(IChatComponent p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_)
        {
            if (p_serialize_1_ is ChatComponentText && p_serialize_1_.getChatStyle().isEmpty() && p_serialize_1_.getSiblings().isEmpty())
            {
            ...
            else
            {
                ...
                if (p_serialize_1_.getSiblings().isEmpty())
                {
                    ...
                    while (var6.hasNext())
                    {
                        ...
                        var5.add(this.serialize(var7, var7.GetType(), p_serialize_3_));
                    }

                    var4.add("extra", var5);
                }

                if (p_serialize_1_ is ChatComponentText)
                {
                    var4.addProperty("text", ((ChatComponentText)p_serialize_1_).getChatComponentText_TextValue());
                }
                else
                {
                    if (!(p_serialize_1_ is ChatComponentTranslation))
                    {
                        throw new System.ArgumentException("Don\'t know how to serialize " + p_serialize_1_ + " as a Component");
                    }
                    ...
                    if (var11.getFormatArgs() != null && var11.getFormatArgs().length > 0)
                    {
                        ...
                        for (int var9 = 0; var9 < var8; ++var9)
                        {
                            ...
                            if (var10 is IChatComponent)
                            {
                                var12.add(this.serialize((IChatComponent)var10, var10.GetType(), p_serialize_3_));
                            }
                            else
                            {
                                var12.add(new JsonPrimitive(var10.ToString()));
                            }
                        }
        ...
        {
            return (IChatComponent)field_150700_a.fromJson(p_150699_0_, typeof(IChatComponent));
        }
        ...
        static IChatComponent_Serializer()
        {
            GsonBuilder var0 = new GsonBuilder();
            var0.registerTypeHierarchyAdapter(typeof(IChatComponent), new IChatComponent_Serializer());
            var0.registerTypeHierarchyAdapter(typeof(ChatStyle), new ChatStyle.Serializer());
