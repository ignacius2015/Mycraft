...
namespace Mycraft.net.minecraft.util
{
    public class AxisAlignedBB
    {
        ...
        public double maxY;
        public double maxZ;
        private static readonly String __OBFID = "CL_00000607";
        /**
     ...
     */
        ...
        {
            return getBoundingBox(minX + p_72325_1_, minY + p_72325_3_, minZ + p_72325_5_, maxX + p_72325_1_, maxY + p_72325_3_, maxZ + p_72325_5_);
        }
        /**
     ...
     */
        ...
        /**
            ...
            */
        public bool intersectsWith(AxisAlignedBB p_72326_1_)
        {
    ...
    */
     ...
     */
        public bool isVecInside(Vec3 p_72318_1_)
        {
